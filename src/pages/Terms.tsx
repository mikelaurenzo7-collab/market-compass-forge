...
const Terms = () => (
  <div className="min-h-screen bg-background text-foreground">
    ...
    <main className="max-w-3xl mx-auto px-6 py-12 prose prose-invert prose-sm">
      ...
      <p className="text-muted-foreground leading-relaxed">By accessing or using Grapevine ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Platform.</p>
      <h2 className="text-lg font-semibold text-foreground mt-8">2. Description of Service</h2>
      <p className="text-muted-foreground leading-relaxed">Grapevine provides private market intelligence, estimated company valuations, deal flow tracking, and related analytics tools for informational purposes only. The Platform is not a registered broker-dealer or investment adviser.</p>
      ...
      <p className="text-muted-foreground leading-relaxed">The Platform is provided "as is" without warranties of any kind. Grapevine shall not be liable for any damages arising from the use of or inability to use the Platform.</p>
      <h2 className="text-lg font-semibold text-foreground mt-8">6. Contact</h2>
      <p className="text-muted-foreground leading-relaxed">For questions regarding these terms, please contact <a href="mailto:legal@grapevine.io" className="text-primary hover:underline">legal@grapevine.io</a>.</p>
    </main>
  </div>
);
