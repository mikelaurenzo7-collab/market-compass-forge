      ...
      const sections: CoverageSection[] = [
        {
          ...
          isSynthetic: financials.every(f => f.is_synthetic),
          lastRefresh: financials[0]?.fetched_at ?? null,
          quality: getQuality(financials.length > 0, financials.every(f => f.is_synthetic), financials.length),
        },
        {
          ...
          isSynthetic: funding.every(f => f.is_synthetic),
          lastRefresh: funding[0]?.fetched_at ?? null,
          quality: getQuality(funding.length > 0, funding.every(f => f.is_synthetic), funding.length),
        },
        {
