...
/** Skeleton for Discover page — search bar + company grid */
export const DiscoverSkeleton = () => (
  <div className="space-y-6">
    <div className="flex gap-2">
      <Skeleton className="h-10 flex-1 max-w-xl rounded-lg shimmer" />
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="rounded-lg border border-border bg-card p-4 space-y-3 shimmer" style={{ animationDelay: `${i * 80}ms` }}>
